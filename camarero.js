...
function abrirImpresionTicket({ titulo, subtitulo, lineas, configLocal, mostrarPrecio = false, mostrarTotal = false, total = 0, pie = '', mostrarLogo = false }) {
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .print-total{display:flex;justify-content:flex-end;gap:14px;margin-top:10px;padding-top:6px;border-top:1px solid #333;font-size:${paperCfg.fontSize + 2}px;font-weight:bold;color:#000}
