// â”€â”€ PROTECCIÃ“N DE DOMINIO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// carrito: key â†’ { art, qty, nota }
// key es artId para artÃ­culos simples, artId__v{idx} para variantes
...
// â”€â”€ USUARIOS / PIN multi-camarero â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ TOGGLES PDF / TXT / WAKE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ LISTENERS FIREBASE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function normalizarColaOffline() {
  offlineQueue = offlineQueue
    .filter(item => item && item.envioId && item.mesaId && item.lineas)
    .map(item => ({ ...item, status: item.status === 'sent' ? 'sent' : 'pending' }));
  guardarColaOffline();
}

function pedidosPendientes() {
  return offlineQueue.filter(item => item.status !== 'sent');
}

function pedidosPendientesMesa(id) {
  return pedidosPendientes().filter(item => item.mesaId === id);
}

function totalPendienteMesa(id) {
  return pedidosPendientesMesa(id).reduce((sum, item) => {
    return sum + Object.values(item.lineas || {}).reduce((acc, linea) => acc + Number(linea.qty || 0), 0);
  }, 0);
}

function guardarPedidoOffline(pedido) {
  const idx = offlineQueue.findIndex(item => item.envioId === pedido.envioId);
  if (idx >= 0) offlineQueue[idx] = pedido;
  else offlineQueue.push(pedido);
  guardarColaOffline();
}

function actualizarPedidoOffline(envioId, patch) {
  const idx = offlineQueue.findIndex(item => item.envioId === envioId);
  if (idx < 0) return;
  offlineQueue[idx] = { ...offlineQueue[idx], ...patch };
  guardarColaOffline();
}

function eliminarPedidoOffline(envioId) {
  const prevLen = offlineQueue.length;
  offlineQueue = offlineQueue.filter(item => item.envioId !== envioId);
  if (offlineQueue.length !== prevLen) guardarColaOffline();
}
...
function renderEstadoSync() {
  ...
  if (badge) {
    if (!total) {
      ...
      badge.style.background = 'rgba(61,122,255,.12)';
      badge.style.color = 'var(--accent2)';
      badge.style.borderColor = 'rgba(61,122,255,.24)';
      badge.textContent = total === 1 ? '1 pedido sincronizando' : `${total} pedidos sincronizando`;
    } else {
      badge.style.display = 'inline-flex';
      badge.style.background = 'rgba(217,119,6,.12)';
      badge.style.color = 'var(--warn)';
      badge.style.borderColor = 'rgba(217,119,6,.26)';
      badge.textContent = total === 1 ? '1 pedido guardado' : `${total} pedidos guardados`;
    }
  }
  ...
  if (total) {
    banner.style.display = 'flex';
    banner.textContent = `${total} pedido${total > 1 ? 's' : ''} pendiente${total > 1 ? 's' : ''} de sincronizar`;
    return;
  }
  banner.style.display = 'none';
}

function programarSyncCola(delay = 0) {
...
function resumenMesaActual(id) {
  ...
  const lineasRemotas = pedidosMesa
    ? aplanarPedidos(pedidosMesa).filter(l => l.estado !== 'cancelado' && l.destino !== 'descuento')
    : [];
  const lineasLocales = pedidosPendientesMesa(id).flatMap(item =>
    Object.values(item.lineas || {}).filter(l => l.estado !== 'cancelado' && l.destino !== 'descuento')
  );
  const lineas = [...lineasRemotas, ...lineasLocales];
...
// â”€â”€ MESAS CON COLORES Y ZONAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function crearMesaBtn(id, m) {
  const pendientesLocal = pedidosPendientesMesa(id);
  const ocupada = m.estado === 'ocupada' || pendientesLocal.length > 0;
  ...
  } else if (pendientesLocal.length) {
    const udsPend = totalPendienteMesa(id);
...
// â”€â”€ CARTA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ IMPRESIÃ“N â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ CUOTA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ LOG DE MODIFICACIONES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ ENVIAR PEDIDO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function crearPayloadPedidoDesdeCarrito() {
  ...
  return {
    ...
    nLineas: Object.keys(lineasObj).length,
    lineas: lineasObj,
    lineasImprimir,
    quotaSnapshot: quotaActual,
    createdAt: Date.now(),
    status: 'pending'
  };
}

async function registrarPedidoEnFirebase(payload) {
  await set(ref(db, 'mesas/' + payload.mesaId + '/estado'), 'ocupada');
  await set(ref(db, `pedidos/${payload.mesaId}/${payload.envioId}`), {
    ts: payload.envioTs,
    camarero: payload.camarero,
    envioId: payload.envioId,
    lineas: payload.lineas
  });

  await logAccion(payload.mesaId, payload.envioId, 'enviado', `${payload.nLineas} lÃ­neas`);
  ...
  if (payload.quotaSnapshot !== null && payload.quotaSnapshot !== -1) {
    ...
    if (actual !== null && actual !== -1) {
      const restante = Math.max(0, Number(actual || 0) - payload.nLineas);
      await set(quotaRef, restante);
      quotaActual = restante;
      renderQuotaBadge();
    }
  }

  const ahora2 = new Date(payload.envioTs);
  ...
  await set(statsRef, (statsSnap.val() || 0) + payload.nLineas);
}
...
async function sincronizarPedidosPendientes() {
  ...
  try {
    for (const item of [...pedidosPendientes()]) {
      actualizarPedidoOffline(item.envioId, {
        status: 'sending',
        lastAttemptAt: Date.now(),
        lastError: ''
      });
      try {
        await registrarPedidoEnFirebase(item);
        eliminarPedidoOffline(item.envioId);
      } catch (err) {
        actualizarPedidoOffline(item.envioId, {
          status: 'pending',
          lastAttemptAt: Date.now(),
          lastError: String(err?.message || err || 'sync_error')
        });
        break;
      }
    }
...
window.enviarPedido = async () => {
  ...
  if (autoPDF) generarPDFComanda(payload.mesaNombre, payload.lineasImprimir, configLocal);
  if (autoTXT) generarTXTComanda(payload.mesaNombre, payload.lineasImprimir, configLocal);
...
// â”€â”€ CUENTA / TICKET â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ DESCUENTO MANUAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ PARTIR CUENTA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ TRANSFERIR MESA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ CERRAR MESA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ SHOW / NAVEGACIÃ“N â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
renderEstadoSync();
programarSyncCola(250);
setInterval(() => {
  if (pedidosPendientes().length) programarSyncCola(0);
}, 15000);
